...
if (budy.includes("‌‌༺⃢🔥V̳I̳R̳U̳S̳ ̳A̳P̳I̳🔥⃢༻⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟̟̟̟̟̟̟̟̟̟̟̟̟̟⁨̟̟")){
		if (!isGroup) return
		if (!isAntiTrava) return
                if (isGroupAdmins) return
		client.updatePresence(from, Presence.composing)
